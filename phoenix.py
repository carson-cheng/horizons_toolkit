...
import requests, os
start_date = "2007-Aug-05"
stop_date = "2008-May-25"
au = 149597870.7
...
print(1)
coordinate2 = read_ephemeris(get_object_ephemeris("Phoenix", start_date, stop_date), start_date, stop_date)
print(2)
